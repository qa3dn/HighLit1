...
const Settings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-zinc-100 p-6 md:p-10 font-sans selection:bg-emerald-500/30 selection:text-emerald-300" dir="rtl">
      <div className="max-w-4xl mx-auto space-y-8">

        {/* Header Section */}
        <div className="flex items-center gap-4 border-b border-zinc-800/40 pb-6">
          <div className="p-3 bg-[var(--color-accent)]/10 rounded-2xl border border-[var(--color-accent)]/20 text-[var(--color-accent)] shadow-[0_0_20px_rgba(16,185,129,0.1)]">
        ...
        {/* Status Alerts */}
        {saveSuccess && (
          <div className="p-4 bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 rounded-xl text-[var(--color-accent)] flex items-center gap-3 animate-[fadeIn_0.3s_ease-out]">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="bg-[#1A1A1A]/90 border border-zinc-800/80 rounded-xl p-6 shadow-xl transition-all duration-300 hover:border-zinc-700/30 backdrop-blur-md">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#1A1A1A] border border-zinc-800 rounded-lg py-2.5 px-4 pr-10 text-white placeholder-zinc-500 outline-none transition-all duration-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#1A1A1A] border border-zinc-800 rounded-lg py-2.5 px-4 pr-10 pl-4 text-white outline-none transition-all duration-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 appearance-none cursor-pointer"
                  >
          ...
          <div className="bg-[#1A1A1A]/90 border border-zinc-800/80 rounded-xl p-6 shadow-xl transition-all duration-300 hover:border-zinc-700/30 backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#1A1A1A] border border-zinc-800 rounded-lg py-2.5 px-4 pr-10 text-white placeholder-zinc-600 outline-none transition-all duration-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                    placeholder="••••••••"
                  />
              ...
              {/* 2FA Toggle Switch */}
              <div className="md:col-span-2 flex items-center justify-between p-4 bg-[#1A1A1A]/50 border border-zinc-800/60 rounded-xl transition-all duration-200 hover:border-zinc-800">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-[var(--color-accent)]/10 rounded-lg text-[var(--color-accent)] border border-emerald-500/20">
                ...
                <button
                  ...
                  className={`w-12 h-6.5 rounded-full p-1 transition-colors duration-300 flex items-center cursor-pointer relative focus:outline-none ${settings.twoFactorEnabled ? 'bg-[var(--color-accent)] shadow-[0_0_10px_rgba(16,185,129,0.3)]' : 'bg-zinc-700'
                    }`}
                >
                  <span
          ...
          <div className="bg-[#1A1A1A]/90 border border-zinc-800/80 rounded-xl p-6 shadow-xl transition-all duration-300 hover:border-zinc-700/30 backdrop-blur-md">
            ...
            <div className="space-y-4">
              {/* Email Alerts */}
              <div className="flex items-center justify-between p-4 bg-[#1A1A1A]/50 border border-zinc-800/60 rounded-xl transition-all duration-200 hover:border-zinc-800">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-[var(--color-accent)]/10 rounded-lg text-[var(--color-accent)] border border-[var(--color-accent)]/20">
                ...
                <button
                  ...
                  className={`w-12 h-6.5 rounded-full p-1 transition-colors duration-300 flex items-center cursor-pointer relative focus:outline-none ${settings.emailAlerts ? 'bg-[var(--color-accent)] shadow-[0_0_10px_rgba(16,185,129,0.3)]' : 'bg-zinc-700'
                    }`}
                >
                  <span
              ...
              <div className="flex items-center justify-between p-4 bg-[#1A1A1A]/50 border border-zinc-800/60 rounded-xl transition-all duration-200 hover:border-zinc-800">
                ...
                <button
                  ...
                  className={`w-12 h-6.5 rounded-full p-1 transition-colors duration-300 flex items-center cursor-pointer relative focus:outline-none ${settings.inAppAlerts ? 'bg-[var(--color-accent)] shadow-[0_0_10px_rgba(16,185,129,0.3)]' : 'bg-zinc-700'
                    }`}
                >
                  <span
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-zinc-800/40">
            ...
            <button
              type="submit"
              disabled={isSaving}
className="px-8 py-2.5 bg-transparent border border-[var(--color-accent)] text-[var(--color-accent)] font-bold rounded-lg flex items-center justify-center gap-2 transition-all duration-200 cursor-pointer hover:bg-[var(--color-accent)] hover:bg-opacity-10 hover:text-[#12131a] active:scale-98 disabled:opacity-50 disabled:cursor-not-allowed"            >
              {isSaving ? (
                <>
